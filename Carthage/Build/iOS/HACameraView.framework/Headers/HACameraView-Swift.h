...
SWIFT_CLASS("_TtC12HACameraView22HACameraViewController")
@interface HACameraViewController : UIViewController
...
@interface HACameraViewController (SWIFT_EXTENSION(HACameraView)) <AVCaptureMetadataOutputObjectsDelegate>
